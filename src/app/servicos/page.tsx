  ...
  return (
    <div className="animate__fadeIn animate__animated flex h-full min-h-screen flex-col items-center justify-center">
      {serviçosData.map((item, key) => (
        ...
        >
          <div className="relative flex w-10/12 items-center justify-center overflow-hidden bg-cover">
            <Image
              src={item.categoria}
              alt=""
              priority={true}
          ...
          <div className="flex w-full flex-col items-center justify-center gap-6 p-6 text-black">
            ...
            {item.imagens ? (
              <div className="min-h-56 flex w-full flex-wrap items-center justify-center gap-10">
