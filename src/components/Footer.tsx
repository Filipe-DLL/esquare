...
export default function Footer() {
  return (
    ...
    //         </li>
    //         <li>
    //           <Link href={`/servicos#Cabeamento Estruturado`}>
    ...
    <footer
      id="Footer"
      className="animate__fadeIn animate__animated bottom-0 flex h-80 w-full flex-col items-center justify-center bg-azulPetrolio p-8 text-gray-50 lg:h-full md:p-2"
    >
      {/* container */}
