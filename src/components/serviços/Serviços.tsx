...
export default function Serviços() {
  return (
    <section id="Serviços" className="h-full w-5/6 flex flex-col items-center justify-center">
      ...
      {/* Titulo */}
      <h1 className="mt-20 flex items-center justify-center text-3xl font-black uppercase">Nossos Serviços</h1>
      ...
      <div className="flex flex-wrap items-end justify-between p-10 gap-8">
        ...
        <Serviço titulo="Prevenção e Combate à Incêndio (PPCI)" imagem={arquitetonico} />
