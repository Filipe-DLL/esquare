...
export default function SectionContatos() {
  return (
    <section
      id="Contato"
      className="py-20 flex h-full w-full flex-col items-center justify-center bg-[#d4e2ff]"
    >
      {/* container */}
      <div className="w-full flex flex-col items-center justify-center gap-8">
        {/* textp */}
        <div className="text-center flex flex-col gap-8">
          <h1 className="text-6xl font-black uppercase">Estamos ansiosos<br />
            para trabalhar com você!</h1>

          <p className="text-4xl font-extrabold">Entre em contato conosco hoje mesmo e deixe-nos<br />
            ajudá-lo a transformar suas ideias em realidade.</p>
        </div>
        {/* botão */}
        <Link href={"/sobre"} className="flex h-full">
          <div className="flex h-full cursor-pointer uppercase items-center justify-center rounded-full bg-[#eeaa6b] p-3 px-12 text-center text-2xl font-bold text-black transition-all ease-in-out hover:bg-[#bb8554]">
            Entre em contato
          </div>
        </Link>
        ...
        <div className="flex gap-5 h-[700px]">
          {/* mapas */}
          <div className="relative flex flex-col w-full h-[700px] max-w-5xl items-center justify-start overflow-hidden">
            <iframe
            ...
            ></iframe>
            <Link href={"/sobre"} className="absolute flex items-center justify-center bottom-0">
              <div className="flex w-auto h-auto cursor-pointer items-center justify-center rounded-full bg-[#161c33] py-3 px-12 text-center text-2xl font-bold text-[#d9d9d9] transition-all ease-in-out hover:bg-[#263059]">
          ...
          {/* insta */}
          <div className="relative flex flex-col w-full h-[700px] max-w-5xl items-center justify-center overflow-hidden">
            <iframe
