...
export default function ServiçoItem(props: props) {
  return (
    <div className="sm:min-h-10 group relative h-full flex-1 rounded-[30px] text-[#0d417b] transition-all ease-in-out hover:-translate-y-3 hover:drop-shadow-md">
      <Link
      ...
      >
        <Image
          ...
          alt=""
          width={150}
          className="min-w-[150px] overflow-hidden rounded-3xl bg-cover object-cover shadow-md sm:w-[20px]"
        />
